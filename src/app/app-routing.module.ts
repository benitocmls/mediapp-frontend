...
const routes: Routes = [
  ...
  { path: 'signos', component: Signos2Component, canActivate: [GuardService],
  
 
  children: [                          //<---- child components declared here
    { path: 'nuevo', component: Signos2EdicionComponent },
    { path: 'edicion/:id', component: Signos2EdicionComponent }
    ]
